(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();function se(){const e=new Uint8Array(12);return crypto.getRandomValues(e),[...e].map(t=>t.toString(16).padStart(2,"0")).join("")}function rt(){return{roomId:se(),inviteToken:se()}}function at({wsUrl:e,roomId:t,inviteToken:n,name:o,onHealth:s,onError:r}){if(!t)throw new Error("A room ID is required.");if(!n)throw new Error("An invitation token is required.");const a=se(),d=[],u=[],g=[],c=[];let l=null,$=!1,E=!1,k=0,C=0,L=0,I=null;const w=v=>s==null?void 0:s({localPeerId:a,status:v,peerCount:C,reconnectAttempts:L,peers:[]});function N(v){const A=JSON.stringify(v);$&&(l==null?void 0:l.readyState)===WebSocket.OPEN?l.send(A):c.push(A)}function T(){for(;c.length&&(l==null?void 0:l.readyState)===WebSocket.OPEN;)l.send(c.shift())}function x(){const v=`${e.replace(/\/$/,"")}/room/${encodeURIComponent(t)}`;l=new WebSocket(v),l.onopen=()=>{$=!0,k=0,N({t:"hello",id:a,token:n,name:o}),T(),w("connected")},l.onmessage=A=>{let P;try{P=JSON.parse(A.data)}catch{return}P.t==="welcome"?(C=P.peers.length,w("connected"),P.peers.forEach(O=>u.forEach(te=>te(O)))):P.t==="peer-join"?(C+=1,w("connected"),u.forEach(O=>O(P.id))):P.t==="peer-leave"?(C=Math.max(0,C-1),w("connected"),g.forEach(O=>O(P.id))):P.t==="evt"&&d.forEach(O=>O(P.payload,P.from))},l.onclose=A=>{if($=!1,E){w("closed");return}if(A.code===4001||A.code===4002){r==null||r({type:"join-error",message:"Could not join room (bad token)."}),w("degraded");return}L+=1,w("reconnecting");const O=Math.min(1e3*2**k,8e3);k+=1,I=setTimeout(x,O)},l.onerror=()=>{r==null||r({type:"ws-error",message:"Relay connection error."})}}return x(),{localPeerId:a,publish:v=>N({t:"evt",payload:v}),publishTo:(v,A)=>N({t:"evt",target:v,payload:A}),onEvent:v=>{d.push(v)},onPeerJoin:v=>u.push(v),onPeerLeave:v=>g.push(v),getPeerIds:()=>[],leave(){E=!0,I&&clearTimeout(I);try{l==null||l.close(1e3,"leave")}catch{}}}}const J={rock:{glyph:"✊",beats:"scissors"},paper:{glyph:"✋",beats:"rock"},scissors:{glyph:"✌️",beats:"paper"}};function it(e){const t=Object.keys(e),n=new Set,o=new Set(t.map(s=>e[s]));if(t.length<2)return{outcome:"incomplete",winners:[],winningThrow:null};if(t.length===2){const[s,r]=t;if(e[s]===e[r])return{outcome:"draw",winners:[],winningThrow:null};const a=J[e[s]].beats===e[r]?s:r;return n.add(a),{outcome:"win",winners:[...n],winningThrow:e[a]}}if(o.size===2){const[s,r]=[...o],a=J[s].beats===r?s:r;return t.forEach(d=>{e[d]===a&&n.add(d)}),{outcome:"win",winners:[...n],winningThrow:a}}return o.size===1?{outcome:"draw",winners:[],winningThrow:null}:{outcome:"stalemate",winners:[],winningThrow:null}}function ct(e){const t=Object.values(e).map(Number);if(!t.length)return{avg:0,spread:0,consensus:!0,hardNo:!1,min:0,max:0};const n=Math.min(...t),o=Math.max(...t),s=t.reduce((a,d)=>a+d,0)/t.length,r=o-n;return{avg:s,spread:r,consensus:r<=1,hardNo:t.some(a=>a===0),min:n,max:o}}const lt=Object.keys(J),dt={id:"rps",label:"Rock · Paper · Scissors",description:"The classic settler of disputes. Head-to-head or whole-team throwdown.",glyphs:"✊ ✋ ✌️",blind:!0,needsConfig:!1,minPlayers:2,defaultConfig:()=>({}),normalizeConfig:()=>({}),validatePick:e=>lt.includes(e),result:e=>it(e)},ut={id:"f2f",label:"Fist to Five",description:"Gauge the room. Zero is a hard no, five is full-throated support.",glyphs:"☝️ 🖐",blind:!0,needsConfig:!1,minPlayers:1,defaultConfig:()=>({}),normalizeConfig:()=>({}),validatePick:e=>Number.isInteger(e)&&e>=0&&e<=5,result:e=>ct(e)},U=[0,1,2,3,5,8,13],$e=["?","coffee"],re={id:"points",label:"Story Pointing",description:"Estimate together, anchor-free. Fibonacci scale, reveal when all hands are in.",glyphs:"1 3 5 8 13",blind:!0,needsConfig:!1,minPlayers:1,defaultConfig:()=>({}),normalizeConfig:()=>({}),validatePick:e=>U.includes(e)||$e.includes(e),result(e){const t=Object.entries(e),n=t.filter(([,c])=>typeof c=="number"),o=t.filter(([,c])=>!U.includes(c)||typeof c!="number").map(([c])=>c),s=n.map(([,c])=>c);if(!s.length)return{avg:null,min:null,max:null,consensus:!1,outliers:[],abstained:o,numericCount:0};const r=Math.min(...s),a=Math.max(...s),d=s.reduce((c,l)=>c+l,0)/s.length,u=U.indexOf(a)-U.indexOf(r)<=1,g=u?[]:n.filter(([,c])=>c===r||c===a).map(([c])=>c);return{avg:d,min:r,max:a,consensus:u,outliers:g,abstained:o,numericCount:s.length}},scale:U,special:$e},ke=["yes","no","abstain"],ft={id:"motion",label:"Motion Vote",description:"Pose a question, vote blind. Yes, no, or abstain — revealed together.",glyphs:"👍 👎",blind:!0,needsConfig:!0,minPlayers:1,defaultConfig:()=>({question:""}),normalizeConfig(e){return{question:typeof(e==null?void 0:e.question)=="string"?e.question.trim().slice(0,200):""}},validatePick:e=>ke.includes(e),result(e){const t={yes:0,no:0,abstain:0};for(const o of Object.values(e))t[o]+=1;const n=t.yes+t.no;return{...t,passed:t.yes>t.no,tied:t.yes===t.no&&n>0,unanimous:n>0&&(t.yes===0||t.no===0)}},options:ke};function mt(e,t){return!Array.isArray(e)||e.length!==t||new Set(e).size!==t?!1:e.every(o=>Number.isInteger(o)&&o>=0&&o<t)}const pt={id:"ranked",label:"Ranked Choice",description:"Everyone privately ranks the options. Borda-count scores, revealed together.",glyphs:"🥇 🥈 🥉",blind:!0,needsConfig:!0,minPlayers:1,defaultConfig:()=>({options:[]}),normalizeConfig(e){const t=Array.isArray(e==null?void 0:e.options)?e.options:[];return{options:[...new Set(t.filter(o=>typeof o=="string").map(o=>o.trim().slice(0,100)).filter(Boolean))].slice(0,10)}},validatePick:(e,t)=>mt(e,t.options.length)&&t.options.length>=2,result(e,t){const n=t.options.length,o=new Array(n).fill(0),s=new Array(n).fill(0);for(const u of Object.values(e))u.forEach((g,c)=>{o[g]+=n-1-c,c===0&&(s[g]+=1)});const r=t.options.map((u,g)=>({option:u,index:g,points:o[g],firsts:s[g]})).sort((u,g)=>g.points-u.points||g.firsts-u.firsts||u.index-g.index),a=r[0],d=r.filter(u=>u.points===a.points&&u.firsts===a.firsts);return{scores:r,winner:d.length===1?a.option:null,tie:d.length>1?d.map(u=>u.option):[],voterCount:Object.keys(e).length}}},Ce=["Mission & Purpose","Pace & Sustainability","Process & Tools","Support & Safety","Fun & Energy"],Se=["r","y","g"];function Ee(e){const{r:t,y:n,g:o}=e;return o>n&&o>t?"g":n>o&&n>t?"y":t>n&&t>o||t===n&&t>=o?"r":"y"}const gt={id:"health",label:"Health Check",description:"Rate the team red / yellow / green across five dimensions, blind, then compare.",glyphs:"🔴 🟡 🟢",blind:!0,needsConfig:!1,minPlayers:1,defaultConfig:()=>({categories:Ce}),normalizeConfig(e){const n=(Array.isArray(e==null?void 0:e.categories)?e.categories:[]).filter(o=>typeof o=="string").map(o=>o.trim().slice(0,60)).filter(Boolean).slice(0,10);return{categories:n.length>=2?n:Ce}},validatePick(e,t){return!e||typeof e!="object"||Array.isArray(e)?!1:t.categories.every((n,o)=>Se.includes(e[o]))},result(e,t){const n=t.categories.map((s,r)=>{const a={r:0,y:0,g:0};for(const d of Object.values(e))a[d[r]]+=1;return{name:s,...a,light:Ee(a)}}),o={r:0,y:0,g:0};for(const s of n)o[s.light]+=1;return{categories:n,overall:Ee(o),raterCount:Object.keys(e).length}},lights:Se};function H(e){if(e===void 0)throw new Error("cannot canonicalize undefined");if(typeof e=="function"||typeof e=="symbol"||typeof e=="bigint")throw new Error(`cannot canonicalize ${typeof e}`);if(typeof e=="number"&&!Number.isFinite(e))throw new Error("cannot canonicalize non-finite number");return e===null||typeof e!="object"?JSON.stringify(e):Array.isArray(e)?`[${e.map(H).join(",")}]`:`{${Object.keys(e).sort().map(o=>`${JSON.stringify(o)}:${H(e[o])}`).join(",")}}`}function ht(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619)>>>0;return t>>>0}const bt={id:"turn",label:"Turn Picker",description:"Fairly picks who goes next. Nobody can rig it — randomness comes from everyone.",glyphs:"🎯",blind:!0,needsConfig:!1,minPlayers:1,defaultConfig:()=>({excluded:[]}),normalizeConfig(e){return{excluded:(Array.isArray(e==null?void 0:e.excluded)?e.excluded:[]).filter(n=>typeof n=="string").slice(0,100)}},validatePick:e=>typeof e=="string"&&e.length>0&&e.length<=64,result(e,t,n){const o=new Set(t.excluded);let s=n.participants.filter(g=>!o.has(g));const r=s.length===0;if(r&&(s=[...n.participants]),!s.length)return{winner:null,eligible:[],exhausted:r};const a=Object.keys(e).sort(),d=H(a.map(g=>[g,e[g]]));return{winner:s.sort()[ht(d)%s.length],eligible:s,exhausted:r}}},W={wwda:{label:"Went Well / Didn’t / Actions",columns:[{key:"well",title:"Went Well"},{key:"not",title:"Didn’t Go Well"},{key:"actions",title:"Actions"}]},ssc:{label:"Start / Stop / Continue",columns:[{key:"start",title:"Start"},{key:"stop",title:"Stop"},{key:"continue",title:"Continue"}]}},yt={id:"retro",label:"Retrospective",description:"Reflect as a team. Cards in columns, blind or live, everyone can rearrange.",glyphs:"🗂️",mode:"board",needsConfig:!0,minPlayers:1,defaultConfig:()=>({template:"wwda",privacy:"blind"}),normalizeConfig(e){const t=e&&W[e.template]?e.template:"wwda",n=e&&e.privacy==="live"?"live":"blind";return{template:t,privacy:n}},columnsFor(e){return W[e.template]?W[e.template].columns:W.wwda.columns},validatePick:()=>!1,result:()=>null},we=[re,ut,ft,pt,gt,bt,yt,dt],vt=Object.fromEntries(we.map(e=>[e.id,e])),$t=we,X=e=>vt[e]||null;function kt(){return{round:0,game:null,config:{},selectFrom:null,names:{},departed:{},commits:{},reveals:{},forced:{},presenceSeq:{},cards:{},cardsRevealed:{},facilitator:{holder:null,term:-1}}}function xe(e,t,n,o){const s={...e};return s[t]={...s[t]||{},[n]:o},s}function Le(e,t){return t.round>e.round?!0:t.round===e.round?e.selectFrom==null||t.from<e.selectFrom:!1}function Ct(e,t){if(!t||typeof t!="object")return e;switch(t.type){case"presence":{const n=Number(t.seq)||0;return(e.presenceSeq[t.from]??-1)>=n&&e.names[t.from]?e:{...e,names:{...e.names,[t.from]:String(t.name||"").slice(0,20)||"peer"},departed:St(e.departed,t.from),presenceSeq:{...e.presenceSeq,[t.from]:n}}}case"select-game":{if(!Le(e,t))return e;const n=t.config&&typeof t.config=="object"?t.config:{};return{...e,round:t.round,game:t.game,config:n,selectFrom:t.from}}case"back-to-lobby":return Le(e,t)?{...e,round:t.round,game:null,config:{},selectFrom:t.from}:e;case"commit":return{...e,commits:xe(e.commits,t.round,t.from,t.hash)};case"reveal":return{...e,reveals:xe(e.reveals,t.round,t.from,{pick:t.pick,nonce:t.nonce})};case"force-reveal":return{...e,forced:{...e.forced,[t.round]:!0}};case"facilitator":{const n=e.facilitator;return t.term>n.term||t.term===n.term&&(n.holder==null||t.holder<n.holder)?{...e,facilitator:{holder:t.holder,term:t.term}}:e}case"card":{const n=e.cards[t.round]||{},o=n[t.cardId];if(!(!o||t.ver>o.ver||t.ver===o.ver&&t.from<o.from))return e;const r=t.card&&typeof t.card=="object"?t.card:{};return{...e,cards:{...e.cards,[t.round]:{...n,[t.cardId]:{ver:t.ver,from:t.from,...r}}}}}case"reveal-cards":return{...e,cardsRevealed:{...e.cardsRevealed,[t.round]:!0}};case"leave":return{...e,departed:{...e.departed,[t.from]:!0}};default:return e}}function St(e,t){if(!(t in e))return e;const n={...e};return delete n[t],n}function Be(e,t){return e.order<t.order?-1:e.order>t.order?1:e.cardId<t.cardId?-1:e.cardId>t.cardId?1:0}function Et(e,t,n,o){const s=e.cards[o]||{};return{columns:t.columnsFor(n).map(a=>({...a,cards:Object.entries(s).filter(([,d])=>d.col===a.key&&!d.deleted).map(([d,u])=>({cardId:d,...u})).sort(Be)})),cardsRevealed:!!e.cardsRevealed[o],privacy:n.privacy}}function je(e){return[...e].sort()[0]??null}function xt(e,t,n,o={}){const s=[...new Set(n)].filter(T=>!e.departed[T]);s.sort();const r=e.facilitator.holder,d=r&&s.includes(r)?r:je(s),u=e.round,g=e.commits[u]||{},c=o[u]||{},l=s.filter(T=>T in g),$=s.length>0&&l.length===s.length,E=!!e.forced[u],k=E||$,C=e.game?X(e.game):null,L=C?C.normalizeConfig(e.config):{};if(C&&C.mode==="board")return{round:u,game:e.game,config:L,phase:"board",participants:s,names:e.names,facilitator:d,isFacilitator:t===d,committedIds:[],lockedCount:0,remaining:s.length,iAmCommitted:!1,revealPicks:null,result:null,board:Et(e,C,L,u)};let I=C?"pick":"lobby",w=null,N=null;if(C&&k){const T={};for(const v of l)v in c&&C.validatePick(c[v],L)&&(T[v]=c[v]);(E?Object.keys(T).length>0:l.every(v=>v in c))&&(I="reveal",N=T,w=C.result(T,L,{round:u,participants:s}))}return{round:u,game:e.game,config:L,phase:I,participants:s,names:e.names,facilitator:d,isFacilitator:t===d,committedIds:l,lockedCount:l.length,remaining:s.length-l.length,iAmCommitted:l.includes(t),revealPicks:N,result:w}}function Lt(e,{onDeliver:t}){const n=new Set,o=[];function s(r,a){!r||typeof r.id!="string"||n.has(r.id)||(n.add(r.id),o.push(r),t(r),a&&e.publish(r))}return e.onEvent((r,a)=>{if(r&&Array.isArray(r.__snapshot)){for(const d of r.__snapshot)s(d,!1);return}s(r,!0)}),e.onPeerJoin(r=>{e.publishTo(r,{__snapshot:o})}),{publish(r){s(r,!0)},log:o,seenIds:n}}async function le(e){const t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t);return[...new Uint8Array(n)].map(o=>o.toString(16).padStart(2,"0")).join("")}const Oe=(e,t)=>`${H(e)}|${t}`;function At(e,t,n=le){return n(Oe(e,t))}async function Pt(e,t,n,o=le){return typeof t!="string"||!t?!1:await o(Oe(e,t))===n}const Z=36,Rt=Z-1;function Ae(e,t){return t<e.length?parseInt(e[t],Z):0}function Q(e="",t=""){let n="",o=0;for(;o<200;){const s=Ae(e,o),r=o<t.length?Ae(t,o):Rt+1;if(r-s>1){const a=s+Math.floor((r-s)/2);return n+a.toString(Z)}n+=s.toString(Z),o+=1}return n+"1"}const Tt=15e3;function It(){const e=new Uint8Array(16);return crypto.getRandomValues(e),[...e].map(t=>t.toString(16).padStart(2,"0")).join("")}function wt({transport:e,name:t,hasher:n=le,now:o=()=>Date.now(),randomNonce:s=It,livenessMs:r=Tt,autoVerify:a=!1,isCreator:d=!1,roomId:u="default",storage:g=typeof localStorage<"u"?localStorage:null}){const c=e.localPeerId;let l=kt();const $={},E=new Map,k=[],C=new Set;let L=null,I=0,w=0;const N=new Set;let T=null;const x=new Map,v=`tablestakes:drafts:${u}`;function A(){if(g)try{g.setItem(v,JSON.stringify([...x]))}catch{}}function P(){if(g)try{const i=g.getItem(v);if(i)for(const[f,h]of JSON.parse(i))x.set(f,h)}catch{}}function O(){x.clear();try{g==null||g.removeItem(v)}catch{}}P();const te=Lt(e,{onDeliver:fe});e.onPeerLeave(i=>{fe({type:"leave",from:i})}),E.set(c,o());function de(){const i=o(),f=new Set([c]);for(const[h,y]of E)h!==c&&i-y<=r&&!l.departed[h]&&f.add(h);return[...f]}function ue(){return de().filter(i=>!l.departed[i])}function D(){const i=M();let f;try{f=H(i)}catch{f=null}if(!(f!==null&&f===T)){T=f;for(const h of N)h(i)}}function F(i){te.publish(i)}function fe(i){if(l=Ct(l,i),i.from&&E.set(i.from,o()),i.type==="reveal"&&i.from!==c&&k.push({round:i.round,from:i.from,pick:i.pick,nonce:i.nonce}),i.type==="reveal-cards"&&i.round===l.round){for(const[f,h]of x)F({id:`card:${f}:1`,type:"card",from:c,round:i.round,cardId:f,ver:1,card:h});O()}me(),he(),D(),a&&k.length&&queueMicrotask(pe)}function me(){if(!l.game||!L||L.round!==l.round||C.has(l.round))return;const i=ue(),f=l.commits[l.round]||{},h=i.length>0&&i.every(y=>y in f);(l.forced[l.round]||h)&&(C.add(l.round),F({id:`reveal:${c}:${l.round}`,type:"reveal",from:c,round:l.round,pick:L.pick,nonce:L.nonce}))}let ne=!1;function pe(){ne||(ne=!0,Promise.resolve(ge()).finally(()=>{ne=!1}))}async function ge(){var h,y;let i=!1;const f=[];for(const b of k){const G=(h=l.commits[b.round])==null?void 0:h[b.from];if(!G){f.push(b);continue}if(await Pt(b.pick,b.nonce,G,n)){$[y=b.round]??($[y]={});const K=$[b.round][b.from];(K===void 0||H(K)!==H(b.pick))&&($[b.round][b.from]=b.pick,i=!0)}}return k.length=0,k.push(...f),i&&D(),i}function M(){const i=xt(l,c,de(),$);if(i.board){const f=new Map;if(!i.board.cardsRevealed)for(const[h,y]of x){const b=f.get(y.col)||[];b.push({cardId:h,from:c,ver:0,pending:!0,...y}),f.set(y.col,b)}i.board={...i.board,columns:i.board.columns.map(h=>({...h,cards:[...h.cards,...f.get(h.key)||[]].map(y=>({...y,mine:y.author===c})).sort(Be)}))}}return i}function oe(i,f){F({id:`fac:${f}:${i}`,type:"facilitator",from:c,holder:i,term:f})}function he(){const i=l.facilitator.holder;if(i==null)return;const f=ue();!f.length||f.includes(i)||je(f)===c&&i!==c&&oe(c,l.facilitator.term+1)}function _e(i){!M().isFacilitator||i===c||!l.names[i]||l.departed[i]||oe(i,l.facilitator.term+1)}function ze(){be(),d&&oe(c,0)}function be(){E.set(c,o()),F({id:`presence:${c}:${I}`,type:"presence",from:c,name:t,seq:I}),I+=1}function Ue(){me(),he(),a&&k.length&&pe(),D()}async function Ve(i){var b;if(!l.game||C.has(l.round))return;const f=l.commits[l.round]||{};if(c in f)return;const h=s(),y=await At(i,h,n);L={round:l.round,pick:i,nonce:h},$[b=l.round]??($[b]={}),$[l.round][c]=i,F({id:`commit:${c}:${l.round}`,type:"commit",from:c,round:l.round,hash:y})}function We(i,f={}){if(!M().isFacilitator)return;const h=l.round+1;L=null,F({id:`select:${h}:${c}`,type:"select-game",from:c,round:h,game:i,config:f})}function Je(){if(!M().isFacilitator)return;const i=l.round+1;L=null,F({id:`lobby:${i}:${c}`,type:"back-to-lobby",from:c,round:i})}function Ye(){M().isFacilitator&&F({id:`force:${l.round}:${c}`,type:"force-reveal",from:c,round:l.round})}function Ke(){F({id:`leave:${c}`,type:"leave",from:c})}function Qe(i){return i.board&&i.board.privacy==="blind"&&!i.board.cardsRevealed}function Y(i,f,h){F({id:`card:${i}:${f}`,type:"card",from:c,round:l.round,cardId:i,ver:f,card:h})}function Xe(i,f,h={}){var ve;const y=M();if(!y.board)return null;const b=`${c}:${w++}`,G=((ve=y.board.columns.find(st=>st.key===i))==null?void 0:ve.cards)||[],K=Q(G.length?G[G.length-1].order:"",""),ye={text:String(f).slice(0,280),col:i,order:K,author:c,deleted:!1,...h};return Qe(y)?(x.set(b,ye),A(),D()):Y(b,1,ye),b}function Ze(i,f){var y;if(x.has(i)){const b=x.get(i);if(b.author!==c)return;x.set(i,{...b,text:String(f).slice(0,280)}),A(),D();return}const h=(y=l.cards[l.round])==null?void 0:y[i];!h||h.author!==c||Y(i,h.ver+1,{...h,text:String(f).slice(0,280)})}function et(i,f,h){var b;if(x.has(i)){const G=x.get(i);x.set(i,{...G,col:f,order:h}),A(),D();return}const y=(b=l.cards[l.round])==null?void 0:b[i];y&&Y(i,y.ver+1,{...y,col:f,order:h})}function tt(i){var h;if(x.has(i)){if(x.get(i).author!==c)return;x.delete(i),A(),D();return}const f=(h=l.cards[l.round])==null?void 0:h[i];!f||f.author!==c||Y(i,f.ver+1,{...f,deleted:!0})}function nt(){const i=M();!i.isFacilitator||!i.board||F({id:`reveal-cards:${l.round}`,type:"reveal-cards",from:c,round:l.round})}function ot(i){return N.add(i),()=>N.delete(i)}return{self:c,join:ze,heartbeat:be,tick:Ue,lock:Ve,selectGame:We,backToLobby:Je,forceReveal:Ye,leave:Ke,handOff:_e,addCard:Xe,editCard:Ze,moveCard:et,deleteCard:tt,revealCards:nt,processVerifications:ge,getView:M,onChange:ot,_debug:()=>({state:l,verified:$})}}const p=e=>document.getElementById(e),m=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function _(e,t){return e?`<div class="lock-note"><strong>Locked in.</strong> Waiting on ${t} player${t===1?"":"s"}…</div>`:'<div class="lock-note">Your pick locks in immediately — choose with intent.</div>'}function z(e,t){return e.isFacilitator?`
    <div class="stage-actions">
      ...
      ${z(e,"Throw again")}`},bind(e,t,n,o){document.querySelectorAll("[data-pick]").forEach(s=>s.addEventListener("click",()=>{n.choice=s.dataset.pick,t.lock(n.choice),o()}))}},jt={renderPick(e,t){const n=e.iAmCommitted;return`
      ${R(e,"Fist to Five")}
      ...
      ${z(e,"Vote again")}`},bind(e,t,n,o){document.querySelectorAll("[data-pick]").forEach(s=>s.addEventListener("click",()=>{n.choice=Number(s.dataset.pick),t.lock(n.choice),o()}))}},Pe={"?":"?",coffee:"☕"},Ot={renderPick(e,t){const n=e.iAmCommitted,o=[...re.scale,...re.special];return`
      ${R(e,"Story Pointing")}
      ...
      ${z(e,"Point again")}`},bind(e,t,n,o){document.querySelectorAll("[data-pick]").forEach(s=>s.addEventListener("click",()=>{const r=s.dataset.pick,a=r==="?"||r==="coffee"?r:Number(r);n.choice=a,t.lock(a),o()}))}},Re={yes:"👍",no:"👎",abstain:"🤷"},Ft={configForm(e){return`
      <div class="field">
      ...
      ${z(e,"New motion")}`},againOpensConfig:!0,bind(e,t,n,o){document.querySelectorAll("[data-pick]").forEach(s=>s.addEventListener("click",()=>{n.choice=s.dataset.pick,t.lock(n.choice),o()}))}},qt={configForm(e){return`
      <div class="field">
...
`).map(n=>n.trim()).filter(Boolean)}},configValid:e=>e.options.length>=2,renderPick(e,t){const n=e.iAmCommitted,o=t.rank||[],s=e.config.options,r=o.length===s.length;return`
      ...
      ${z(e,"Vote again")}`},bind(e,t,n,o){document.querySelectorAll("[data-rank]").forEach(a=>a.addEventListener("click",()=>{n.rank=[...n.rank||[],Number(a.dataset.rank)],o()}));const s=document.getElementById("resetRankBtn");s&&s.addEventListener("click",()=>{n.rank=[],o()});const r=document.getElementById("lockRankBtn");r&&r.addEventListener("click",()=>{(n.rank||[]).length===e.config.options.length&&(t.lock(n.rank),o())})}},Te={r:"🔴",y:"🟡",g:"🟢"},Nt={renderPick(e,t){const n=e.iAmCommitted,o=t.ratings||{},s=e.config.categories,r=s.every((a,d)=>o[d]);return`
      ${R(e,"Health Check")}
      ...
      ${e.isFacilitator?`
        <div class="stage-actions">
          ...
          <button class="btn-ghost" id="lobbyBtn">Change game</button>
        </div>`:z(e,"Pick again")}`},bind(e,t,n,o){const s=document.getElementById("drawBtn");s&&s.addEventListener("click",()=>{t.lock(Mt()),o()});const r=document.getElementById("againExcludeBtn");r&&r.addEventListener("click",()=>{const a=e.result,d=a.exhausted?[]:e.config.excluded||[],u=a.winner?[...new Set([...d,a.winner])]:d;t.selectGame("turn",{excluded:u})})}};function Ie(e,{title:t}={}){const n=[];t&&n.push(`# ${t}`,"");for(const o of e.board.columns){if(n.push(`## ${o.title}`),!o.cards.length)n.push("_(empty)_");else for(const s of o.cards){const r=e.names[s.author]||"unknown";n.push(`- ${s.text} — _${r}_`)}n.push("")}return n.join(`
`).trim()+`
`}async function Dt(e){try{await navigator.clipboard.writeText(e)}catch{prompt("Copy this:",e);return}const t=p("toast");t&&(t.textContent="Copied",t.classList.add("show"),setTimeout(()=>{t.classList.remove("show"),t.textContent="Link copied"},1800))}function Ht(e,t){const n=new Blob([e],{type:"text/markdown"}),o=URL.createObjectURL(n),s=document.createElement("a");s.href=o,s.download=t,document.body.appendChild(s),s.click(),s.remove(),URL.revokeObjectURL(o)}const _t={configForm(e){const t=e.template||"wwda",n=e.privacy||"blind";return`
      <div class="field">
      ...
      </div>`},bindBoard(e,t){const n=e.board.columns.map(d=>d.key);document.querySelectorAll(".board-cards").forEach(d=>{const u=d.dataset.col;d.querySelectorAll("[data-act]").forEach(g=>g.addEventListener("click",()=>{const c=g.dataset.card,l=g.dataset.act,$=e.board.columns.find(k=>k.key===u).cards,E=$.findIndex(k=>k.cardId===c);if(l==="delete"){t.deleteCard(c);return}if(l==="up"&&E>0){const k=E>=2?$[E-2].order:"";t.moveCard(c,u,Q(k,$[E-1].order))}else if(l==="down"&&E<$.length-1){const k=E+2<$.length?$[E+2].order:"";t.moveCard(c,u,Q($[E+1].order,k))}else if(l==="left"||l==="right"){const k=n[(n.indexOf(u)+(l==="right"?1:n.length-1))%n.length],C=e.board.columns.find(I=>I.key===k).cards,L=C.length?C[C.length-1].order:"";t.moveCard(c,k,Q(L,""))}}))}),document.querySelectorAll(".bc-add").forEach(d=>d.addEventListener("submit",u=>{u.preventDefault();const g=d.querySelector("input"),c=g.value.trim();c&&t.addCard(d.dataset.col,c),g.value=""}));const o=document.getElementById("revealCardsBtn");o&&o.addEventListener("click",()=>t.revealCards());const s=document.getElementById("lobbyBtn");s&&s.addEventListener("click",()=>t.backToLobby());const r=document.getElementById("exportMdBtn");r&&r.addEventListener("click",()=>Dt(Ie(e)));const a=document.getElementById("downloadMdBtn");a&&a.addEventListener("click",()=>Ht(Ie(e),"retro.md"))}},zt={rps:Bt,f2f:jt,points:Ot,motion:Ft,ranked:qt,health:Nt,turn:Gt,retro:_t},ee=e=>zt[e]||null;function Ut(e,t){if(!e.isFacilitator)return`
      <div class="stage-kicker">Round table</div>
      <div class="stage-title">Waiting on the <em>facilitator</em></div>
      <p class="waiting-host">${m(e.names[e.facilitator]||"The facilitator")} is choosing a game…</p>`;if(t.configGame){const n=X(t.configGame),o=ee(t.configGame);return`
