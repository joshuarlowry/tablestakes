(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();function se(){const e=new Uint8Array(12);return crypto.getRandomValues(e),[...e].map(t=>t.toString(16).padStart(2,"0")).join("")}function mt(){return{roomId:se(),inviteToken:se()}}function ft({wsUrl:e,roomId:t,inviteToken:n,name:o,onHealth:s,onError:r}){if(!t)throw new Error("A room ID is required.");if(!n)throw new Error("An invitation token is required.");const a=se(),u=[],d=[],f=[],c=[];let l=null,b=!1,$=!1,k=0,x=0,L=0,P=null;const R=C=>s==null?void 0:s({localPeerId:a,status:C,peerCount:x,reconnectAttempts:L,peers:[]});function N(C){const T=JSON.stringify(C);b&&(l==null?void 0:l.readyState)===WebSocket.OPEN?l.send(T):c.push(T)}function w(){for(;c.length&&(l==null?void 0:l.readyState)===WebSocket.OPEN;)l.send(c.shift())}function E(){const C=`${e.replace(/\/$/,"")}/room/${encodeURIComponent(t)}`;l=new WebSocket(C),l.onopen=()=>{b=!0,k=0,N({t:"hello",id:a,token:n,name:o}),w(),R("connected")},l.onmessage=T=>{let A;try{A=JSON.parse(T.data)}catch{return}A.t==="welcome"?(x=A.peers.length,R("connected"),A.peers.forEach(F=>d.forEach(te=>te(F)))):A.t==="peer-join"?(x+=1,R("connected"),d.forEach(F=>F(A.id))):A.t==="peer-leave"?(x=Math.max(0,x-1),R("connected"),f.forEach(F=>F(A.id))):A.t==="evt"&&u.forEach(F=>F(A.payload,A.from))},l.onclose=T=>{if(b=!1,$){R("closed");return}if(T.code===4001||T.code===4002){r==null||r({type:"join-error",message:"Could not join room (bad token)."}),R("degraded");return}L+=1,R("reconnecting");const F=Math.min(1e3*2**k,8e3);k+=1,P=setTimeout(E,F)},l.onerror=()=>{r==null||r({type:"ws-error",message:"Relay connection error."})}}return E(),{localPeerId:a,publish:C=>N({t:"evt",payload:C}),publishTo:(C,T)=>N({t:"evt",target:C,payload:T}),onEvent:C=>{u.push(C)},onPeerJoin:C=>d.push(C),onPeerLeave:C=>f.push(C),getPeerIds:()=>[],leave(){$=!0,P&&clearTimeout(P);try{l==null||l.close(1e3,"leave")}catch{}}}}const K={rock:{glyph:"✊",beats:"scissors"},paper:{glyph:"✋",beats:"rock"},scissors:{glyph:"✌️",beats:"paper"}};function pt(e){const t=Object.keys(e),n=new Set,o=new Set(t.map(s=>e[s]));if(t.length<2)return{outcome:"incomplete",winners:[],winningThrow:null};if(t.length===2){const[s,r]=t;if(e[s]===e[r])return{outcome:"draw",winners:[],winningThrow:null};const a=K[e[s]].beats===e[r]?s:r;return n.add(a),{outcome:"win",winners:[...n],winningThrow:e[a]}}if(o.size===2){const[s,r]=[...o],a=K[s].beats===r?s:r;return t.forEach(u=>{e[u]===a&&n.add(u)}),{outcome:"win",winners:[...n],winningThrow:a}}return o.size===1?{outcome:"draw",winners:[],winningThrow:null}:{outcome:"stalemate",winners:[],winningThrow:null}}function gt(e){const t=Object.values(e).map(Number);if(!t.length)return{avg:0,spread:0,consensus:!0,hardNo:!1,min:0,max:0};const n=Math.min(...t),o=Math.max(...t),s=t.reduce((a,u)=>a+u,0)/t.length,r=o-n;return{avg:s,spread:r,consensus:r<=1,hardNo:t.some(a=>a===0),min:n,max:o}}const ht=Object.keys(K),bt={id:"rps",label:"Rock · Paper · Scissors",description:"The classic settler of disputes. Head-to-head or whole-team throwdown.",glyphs:"✊ ✋ ✌️",blind:!0,needsConfig:!1,minPlayers:2,defaultConfig:()=>({}),normalizeConfig:()=>({}),validatePick:e=>ht.includes(e),result:e=>pt(e)},yt={id:"f2f",label:"Fist to Five",description:"Gauge the room. Zero is a hard no, five is full-throated support.",glyphs:"☝️ 🖐",blind:!0,needsConfig:!1,minPlayers:1,defaultConfig:()=>({}),normalizeConfig:()=>({}),validatePick:e=>Number.isInteger(e)&&e>=0&&e<=5,result:e=>gt(e)},V=[0,1,2,3,5,8,13],ke=["?","coffee"],re={id:"points",label:"Story Pointing",description:"Estimate together, anchor-free. Fibonacci scale, reveal when all hands are in.",glyphs:"1 3 5 8 13",blind:!0,needsConfig:!1,minPlayers:1,defaultConfig:()=>({}),normalizeConfig:()=>({}),validatePick:e=>V.includes(e)||ke.includes(e),result(e){const t=Object.entries(e),n=t.filter(([,c])=>typeof c=="number"),o=t.filter(([,c])=>!V.includes(c)||typeof c!="number").map(([c])=>c),s=n.map(([,c])=>c);if(!s.length)return{avg:null,min:null,max:null,consensus:!1,outliers:[],abstained:o,numericCount:0};const r=Math.min(...s),a=Math.max(...s),u=s.reduce((c,l)=>c+l,0)/s.length,d=V.indexOf(a)-V.indexOf(r)<=1,f=d?[]:n.filter(([,c])=>c===r||c===a).map(([c])=>c);return{avg:u,min:r,max:a,consensus:d,outliers:f,abstained:o,numericCount:s.length}},scale:V,special:ke},Ce=["yes","no","abstain"],vt={id:"motion",label:"Motion Vote",description:"Pose a question, vote blind. Yes, no, or abstain — revealed together.",glyphs:"👍 👎",blind:!0,needsConfig:!0,minPlayers:1,defaultConfig:()=>({question:""}),normalizeConfig(e){return{question:typeof(e==null?void 0:e.question)=="string"?e.question.trim().slice(0,200):""}},validatePick:e=>Ce.includes(e),result(e){const t={yes:0,no:0,abstain:0};for(const o of Object.values(e))t[o]+=1;const n=t.yes+t.no;return{...t,passed:t.yes>t.no,tied:t.yes===t.no&&n>0,unanimous:n>0&&(t.yes===0||t.no===0)}},options:Ce};function $t(e,t){return!Array.isArray(e)||e.length!==t||new Set(e).size!==t?!1:e.every(o=>Number.isInteger(o)&&o>=0&&o<t)}const kt={id:"ranked",label:"Ranked Choice",description:"Everyone privately ranks the options. Borda-count scores, revealed together.",glyphs:"🥇 🥈 🥉",blind:!0,needsConfig:!0,minPlayers:1,defaultConfig:()=>({options:[]}),normalizeConfig(e){const t=Array.isArray(e==null?void 0:e.options)?e.options:[];return{options:[...new Set(t.filter(o=>typeof o=="string").map(o=>o.trim().slice(0,100)).filter(Boolean))].slice(0,10)}},validatePick:(e,t)=>$t(e,t.options.length)&&t.options.length>=2,result(e,t){const n=t.options.length,o=new Array(n).fill(0),s=new Array(n).fill(0);for(const d of Object.values(e))d.forEach((f,c)=>{o[f]+=n-1-c,c===0&&(s[f]+=1)});const r=t.options.map((d,f)=>({option:d,index:f,points:o[f],firsts:s[f]})).sort((d,f)=>f.points-d.points||f.firsts-d.firsts||d.index-f.index),a=r[0],u=r.filter(d=>d.points===a.points&&d.firsts===a.firsts);return{scores:r,winner:u.length===1?a.option:null,tie:u.length>1?u.map(d=>d.option):[],voterCount:Object.keys(e).length}}},xe=["Mission & Purpose","Pace & Sustainability","Process & Tools","Support & Safety","Fun & Energy"],Se=["r","y","g"];function Ee(e){const{r:t,y:n,g:o}=e;return o>n&&o>t?"g":n>o&&n>t?"y":t>n&&t>o||t===n&&t>=o?"r":"y"}const Ct={id:"health",label:"Health Check",description:"Rate the team red / yellow / green across five dimensions, blind, then compare.",glyphs:"🔴 🟡 🟢",blind:!0,needsConfig:!1,minPlayers:1,defaultConfig:()=>({categories:xe}),normalizeConfig(e){const n=(Array.isArray(e==null?void 0:e.categories)?e.categories:[]).filter(o=>typeof o=="string").map(o=>o.trim().slice(0,60)).filter(Boolean).slice(0,10);return{categories:n.length>=2?n:xe}},validatePick(e,t){return!e||typeof e!="object"||Array.isArray(e)?!1:t.categories.every((n,o)=>Se.includes(e[o]))},result(e,t){const n=t.categories.map((s,r)=>{const a={r:0,y:0,g:0};for(const u of Object.values(e))a[u[r]]+=1;return{name:s,...a,light:Ee(a)}}),o={r:0,y:0,g:0};for(const s of n)o[s.light]+=1;return{categories:n,overall:Ee(o),raterCount:Object.keys(e).length}},lights:Se};function _(e){if(e===void 0)throw new Error("cannot canonicalize undefined");if(typeof e=="function"||typeof e=="symbol"||typeof e=="bigint")throw new Error(`cannot canonicalize ${typeof e}`);if(typeof e=="number"&&!Number.isFinite(e))throw new Error("cannot canonicalize non-finite number");return e===null||typeof e!="object"?JSON.stringify(e):Array.isArray(e)?`[${e.map(_).join(",")}]`:`{${Object.keys(e).sort().map(o=>`${JSON.stringify(o)}:${_(e[o])}`).join(",")}}`}function xt(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619)>>>0;return t>>>0}const St={id:"turn",label:"Turn Picker",description:"Fairly picks who goes next. Nobody can rig it — randomness comes from everyone.",glyphs:"🎯",blind:!0,needsConfig:!1,minPlayers:1,defaultConfig:()=>({excluded:[]}),normalizeConfig(e){return{excluded:(Array.isArray(e==null?void 0:e.excluded)?e.excluded:[]).filter(n=>typeof n=="string").slice(0,100)}},validatePick:e=>typeof e=="string"&&e.length>0&&e.length<=64,result(e,t,n){const o=new Set(t.excluded);let s=n.participants.filter(f=>!o.has(f));const r=s.length===0;if(r&&(s=[...n.participants]),!s.length)return{winner:null,eligible:[],exhausted:r};const a=Object.keys(e).sort(),u=_(a.map(f=>[f,e[f]]));return{winner:s.sort()[xt(u)%s.length],eligible:s,exhausted:r}}},Y={wwda:{label:"Went Well / Didn’t / Actions",columns:[{key:"well",title:"Went Well"},{key:"not",title:"Didn’t Go Well"},{key:"actions",title:"Actions"}]},ssc:{label:"Start / Stop / Continue",columns:[{key:"start",title:"Start"},{key:"stop",title:"Stop"},{key:"continue",title:"Continue"}]}},Et={id:"retro",label:"Retrospective",description:"Reflect as a team. Cards in columns, blind or live, everyone can rearrange.",glyphs:"🗂️",mode:"board",needsConfig:!0,minPlayers:1,defaultConfig:()=>({template:"wwda",privacy:"blind"}),normalizeConfig(e){const t=e&&Y[e.template]?e.template:"wwda",n=e&&e.privacy==="live"?"live":"blind";return{template:t,privacy:n}},columnsFor(e){return Y[e.template]?Y[e.template].columns:Y.wwda.columns},validatePick:()=>!1,result:()=>null},Lt=[{key:"planned",title:"What we planned"},{key:"happened",title:"What actually happened"},{key:"why",title:"Why — what worked & what didn’t"},{key:"next",title:"What we’ll do next time"},{key:"timeline",title:"Timeline",timeline:!0}];function Le(e){if(typeof e!="string")return null;const t=e.trim().toLowerCase().match(/^(\d{1,2})(?::(\d{2}))?\s*(am|pm|a|p)?$/);if(!t)return null;let n=parseInt(t[1],10);const o=t[2]?parseInt(t[2],10):0,s=t[3];if(o>59)return null;if(s){if(n<1||n>12)return null;s[0]==="p"&&n!==12&&(n+=12),s[0]==="a"&&n===12&&(n=0)}else if(n>23)return null;return n*60+o}function ae(e,t){return e.order<t.order?-1:e.order>t.order?1:e.cardId<t.cardId?-1:e.cardId>t.cardId?1:0}function Tt(e,t){const n=Le(e.time),o=Le(t.time);return n!==null&&o!==null?n!==o?n-o:ae(e,t):n!==null?-1:o!==null?1:ae(e,t)}const At={id:"aar",label:"After-Action Review",description:"Debrief as a team: what was planned, what happened, why, and a shared timeline.",glyphs:"📋",mode:"board",needsConfig:!1,minPlayers:1,defaultConfig:()=>({privacy:"live"}),normalizeConfig(){return{privacy:"live"}},columnsFor(){return Lt},cardComparatorFor(e){return e.timeline?Tt:ae},validatePick:()=>!1,result:()=>null},Oe=[re,yt,vt,kt,Ct,St,Et,At,bt],It=Object.fromEntries(Oe.map(e=>[e.id,e])),Fe=Oe,Z=e=>It[e]||null;function wt(){return{round:0,game:null,config:{},selectFrom:null,names:{},departed:{},commits:{},reveals:{},forced:{},presenceSeq:{},cards:{},cardsRevealed:{},facilitator:{holder:null,term:-1}}}function Te(e,t,n,o){const s={...e};return s[t]={...s[t]||{},[n]:o},s}function Ae(e,t){return t.round>e.round?!0:t.round===e.round?e.selectFrom==null||t.from<e.selectFrom:!1}function Bt(e,t){if(!t||typeof t!="object")return e;switch(t.type){case"presence":{const n=Number(t.seq)||0;return(e.presenceSeq[t.from]??-1)>=n&&e.names[t.from]?e:{...e,names:{...e.names,[t.from]:String(t.name||"").slice(0,20)||"peer"},departed:Pt(e.departed,t.from),presenceSeq:{...e.presenceSeq,[t.from]:n}}}case"select-game":{if(!Ae(e,t))return e;const n=t.config&&typeof t.config=="object"?t.config:{};return{...e,round:t.round,game:t.game,config:n,selectFrom:t.from}}case"back-to-lobby":return Ae(e,t)?{...e,round:t.round,game:null,config:{},selectFrom:t.from}:e;case"commit":return{...e,commits:Te(e.commits,t.round,t.from,t.hash)};case"reveal":return{...e,reveals:Te(e.reveals,t.round,t.from,{pick:t.pick,nonce:t.nonce})};case"force-reveal":return{...e,forced:{...e.forced,[t.round]:!0}};case"facilitator":{const n=e.facilitator;return t.term>n.term||t.term===n.term&&(n.holder==null||t.holder<n.holder)?{...e,facilitator:{holder:t.holder,term:t.term}}:e}case"card":{const n=e.cards[t.round]||{},o=n[t.cardId];if(!(!o||t.ver>o.ver||t.ver===o.ver&&t.from<o.from))return e;const r=t.card&&typeof t.card=="object"?t.card:{};return{...e,cards:{...e.cards,[t.round]:{...n,[t.cardId]:{...r,ver:t.ver,from:t.from}}}}}case"reveal-cards":return{...e,cardsRevealed:{...e.cardsRevealed,[t.round]:!0}};case"leave":return{...e,departed:{...e.departed,[t.from]:!0}};default:return e}}function Pt(e,t){if(!(t in e))return e;const n={...e};return delete n[t],n}function qe(e,t){return e.order<t.order?-1:e.order>t.order?1:e.cardId<t.cardId?-1:e.cardId>t.cardId?1:0}function Rt(e,t,n,o){const s=e.cards[o]||{};return{columns:t.columnsFor(n).map(a=>{const u=t.cardComparatorFor?t.cardComparatorFor(a,n):qe;return{...a,cards:Object.entries(s).filter(([,d])=>d.col===a.key&&!d.deleted).map(([d,f])=>({cardId:d,...f})).sort(u)}}),cardsRevealed:!!e.cardsRevealed[o],privacy:n.privacy}}function Me(e){return[...e].sort()[0]??null}function jt(e,t,n,o={}){const s=[...new Set(n)].filter(w=>!e.departed[w]);s.sort();const r=e.facilitator.holder,u=r&&s.includes(r)?r:Me(s),d=e.round,f=e.commits[d]||{},c=o[d]||{},l=s.filter(w=>w in f),b=s.length>0&&l.length===s.length,$=!!e.forced[d],k=$||b,x=e.game?Z(e.game):null,L=x?x.normalizeConfig(e.config):{};if(x&&x.mode==="board")return{round:d,game:e.game,config:L,phase:"board",participants:s,names:e.names,facilitator:u,isFacilitator:t===u,committedIds:[],lockedCount:0,remaining:s.length,iAmCommitted:!1,revealPicks:null,result:null,board:Rt(e,x,L,d)};let P=x?"pick":"lobby",R=null,N=null;if(x&&k){const w={};for(const C of l)C in c&&x.validatePick(c[C],L)&&(w[C]=c[C]);($?Object.keys(w).length>0:l.every(C=>C in c))&&(P="reveal",N=w,R=x.result(w,L,{round:d,participants:s}))}return{round:d,game:e.game,config:L,phase:P,participants:s,names:e.names,facilitator:u,isFacilitator:t===u,committedIds:l,lockedCount:l.length,remaining:s.length-l.length,iAmCommitted:l.includes(t),revealPicks:N,result:R}}function Ot(e,{onDeliver:t}){const n=new Set,o=[];function s(r,a){!r||typeof r.id!="string"||n.has(r.id)||(n.add(r.id),o.push(r),t(r),a&&e.publish(r))}return e.onEvent((r,a)=>{if(r&&Array.isArray(r.__snapshot)){for(const u of r.__snapshot)s(u,!1);return}s(r,!0)}),e.onPeerJoin(r=>{e.publishTo(r,{__snapshot:o})}),{publish(r){s(r,!0)},log:o,seenIds:n}}async function de(e){const t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t);return[...new Uint8Array(n)].map(o=>o.toString(16).padStart(2,"0")).join("")}const Ne=(e,t)=>`${_(e)}|${t}`;function Ft(e,t,n=de){return n(Ne(e,t))}async function qt(e,t,n,o=de){return typeof t!="string"||!t?!1:await o(Ne(e,t))===n}const Q=36,Mt=Q-1;function Ie(e,t){return t<e.length?parseInt(e[t],Q):0}function H(e="",t=""){let n="",o=0;for(;o<200;){const s=Ie(e,o),r=o<t.length?Ie(t,o):Mt+1;if(r-s>1){const a=s+Math.floor((r-s)/2);return n+a.toString(Q)}n+=s.toString(Q),o+=1}return n+"1"}function Nt(e=""){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)&65535;return(t%1296).toString(Q).padStart(2,"0")}function Gt(e="",t=""){return H(e,"")+Nt(t)}const Dt=15e3;function _t(){const e=new Uint8Array(16);return crypto.getRandomValues(e),[...e].map(t=>t.toString(16).padStart(2,"0")).join("")}function Ht({transport:e,name:t,hasher:n=de,now:o=()=>Date.now(),randomNonce:s=_t,livenessMs:r=Dt,autoVerify:a=!1,isCreator:u=!1,roomId:d="default",storage:f=typeof localStorage<"u"?localStorage:null}){const c=e.localPeerId;let l=wt();const b={},$=new Map,k=[],x=new Set;let L=null,P=0,R=0;const N=new Set;let w=null;const E=new Map,C=`tablestakes:drafts:${d}`;function T(){if(f)try{f.setItem(C,JSON.stringify([...E]))}catch{}}function A(){if(f)try{const i=f.getItem(C);if(i)for(const[p,h]of JSON.parse(i))E.set(p,h)}catch{}}function F(){E.clear();try{f==null||f.removeItem(C)}catch{}}A();const te=Ot(e,{onDeliver:fe});e.onPeerLeave(i=>{fe({type:"leave",from:i})}),$.set(c,o());function ue(){const i=o(),p=new Set([c]);for(const[h,v]of $)h!==c&&i-v<=r&&!l.departed[h]&&p.add(h);return[...p]}function me(){return ue().filter(i=>!l.departed[i])}function G(){const i=D();let p;try{p=_(i)}catch{p=null}if(!(p!==null&&p===w)){w=p;for(const h of N)h(i)}}function q(i){te.publish(i)}function fe(i){if(l=Bt(l,i),i.from&&$.set(i.from,o()),i.type==="reveal"&&i.from!==c&&k.push({round:i.round,from:i.from,pick:i.pick,nonce:i.nonce}),i.type==="reveal-cards"&&i.round===l.round){for(const[p,h]of E)q({id:`card:${p}:1`,type:"card",from:c,round:i.round,cardId:p,ver:1,card:h});F()}pe(),be(),G(),a&&k.length&&queueMicrotask(ge)}function pe(){if(!l.game||!L||L.round!==l.round||x.has(l.round))return;const i=me(),p=l.commits[l.round]||{},h=i.length>0&&i.every(v=>v in p);(l.forced[l.round]||h)&&(x.add(l.round),q({id:`reveal:${c}:${l.round}`,type:"reveal",from:c,round:l.round,pick:L.pick,nonce:L.nonce}))}let ne=!1;function ge(){ne||(ne=!0,Promise.resolve(he()).finally(()=>{ne=!1}))}async function he(){var h,v;let i=!1;const p=[];for(const y of k){const B=(h=l.commits[y.round])==null?void 0:h[y.from];if(!B){p.push(y);continue}if(await qt(y.pick,y.nonce,B,n)){b[v=y.round]??(b[v]={});const X=b[y.round][y.from];(X===void 0||_(X)!==_(y.pick))&&(b[y.round][y.from]=y.pick,i=!0)}}return k.length=0,k.push(...p),i&&G(),i}function D(){const i=jt(l,c,ue(),b);if(i.board){const p=new Map;if(!i.board.cardsRevealed)for(const[h,v]of E){const y=p.get(v.col)||[];y.push({cardId:h,from:c,ver:0,pending:!0,...v}),p.set(v.col,y)}i.board={...i.board,columns:i.board.columns.map(h=>{const v=p.get(h.key),y=v?[...h.cards,...v].sort(qe):h.cards;return{...h,cards:y.map(B=>({...B,mine:B.author===c}))}})}}return i}function oe(i,p){q({id:`fac:${p}:${i}`,type:"facilitator",from:c,holder:i,term:p})}function be(){const i=l.facilitator.holder;if(i==null)return;const p=me();!p.length||p.includes(i)||Me(p)===c&&i!==c&&oe(c,l.facilitator.term+1)}function Ye(i){!D().isFacilitator||i===c||!l.names[i]||l.departed[i]||oe(i,l.facilitator.term+1)}function Ke(){ye(),u&&oe(c,0)}function ye(){$.set(c,o()),q({id:`presence:${c}:${P}`,type:"presence",from:c,name:t,seq:P}),P+=1}function Qe(){pe(),be(),a&&k.length&&ge(),G()}async function Xe(i){var y;if(!l.game||x.has(l.round))return;const p=l.commits[l.round]||{};if(c in p)return;const h=s(),v=await Ft(i,h,n);L={round:l.round,pick:i,nonce:h},b[y=l.round]??(b[y]={}),b[l.round][c]=i,q({id:`commit:${c}:${l.round}`,type:"commit",from:c,round:l.round,hash:v})}function Ze(i,p={}){if(!D().isFacilitator)return;const h=l.round+1;L=null,q({id:`select:${h}:${c}`,type:"select-game",from:c,round:h,game:i,config:p})}function et(){if(!D().isFacilitator)return;const i=l.round+1;L=null,q({id:`lobby:${i}:${c}`,type:"back-to-lobby",from:c,round:i})}function tt(){D().isFacilitator&&q({id:`force:${l.round}:${c}`,type:"force-reveal",from:c,round:l.round})}function nt(){q({id:`leave:${c}`,type:"leave",from:c})}function ot(i){return i.board&&i.board.privacy==="blind"&&!i.board.cardsRevealed}function W(i,p,h){q({id:`card:${i}:${p}`,type:"card",from:c,round:l.round,cardId:i,ver:p,card:h})}function st(i,p,h={}){var $e;const v=D();if(!v.board)return null;const y=`${c}:${R++}`,B=(($e=v.board.columns.find(ut=>ut.key===i))==null?void 0:$e.cards)||[],X=Gt(B.length?B[B.length-1].order:"",c),ve={text:String(p).slice(0,280),col:i,order:X,author:c,deleted:!1,...h};return ot(v)?(E.set(y,ve),T(),G()):W(y,1,ve),y}function rt(i,p){var v;if(E.has(i)){const y=E.get(i);if(y.author!==c)return;E.set(i,{...y,text:String(p).slice(0,280)}),T(),G();return}const h=(v=l.cards[l.round])==null?void 0:v[i];!h||h.author!==c||W(i,h.ver+1,{...h,text:String(p).slice(0,280)})}function at(i,p,h){var y;if(E.has(i)){const B=E.get(i);E.set(i,{...B,col:p,order:h}),T(),G();return}const v=(y=l.cards[l.round])==null?void 0:y[i];v&&W(i,v.ver+1,{...v,col:p,order:h})}function it(i,p){var y;const h=String(p).slice(0,20);if(E.has(i)){const B=E.get(i);E.set(i,{...B,time:h}),T(),G();return}const v=(y=l.cards[l.round])==null?void 0:y[i];v&&W(i,v.ver+1,{...v,time:h})}function ct(i){var h;if(E.has(i)){if(E.get(i).author!==c)return;E.delete(i),T(),G();return}const p=(h=l.cards[l.round])==null?void 0:h[i];!p||p.author!==c||W(i,p.ver+1,{...p,deleted:!0})}function lt(){const i=D();!i.isFacilitator||!i.board||q({id:`reveal-cards:${l.round}`,type:"reveal-cards",from:c,round:l.round})}function dt(i){return N.add(i),()=>N.delete(i)}return{self:c,join:Ke,heartbeat:ye,tick:Qe,lock:Xe,selectGame:Ze,backToLobby:et,forceReveal:tt,leave:nt,handOff:Ye,addCard:st,editCard:rt,moveCard:at,deleteCard:ct,retimeCard:it,revealCards:lt,processVerifications:he,getView:D,onChange:dt,_debug:()=>({state:l,verified:b})}}const g=e=>document.getElementById(e),m=e=>String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function z(e,t){return e?`<div class="lock-note"><strong>Locked in.</strong> Waiting on ${t} player${t===1?"":"s"}…</div>`:'<div class="lock-note">Your pick locks in immediately — choose with intent.</div>'}function U(e,t){return e.isFacilitator?`
    <div class="stage-actions">
      <button class="btn-primary" id="againBtn">${m(t)}</button>
      <button class="btn-ghost" id="lobbyBtn">Change game</button>
    </div>`:`<div class="lock-note">Waiting on ${m(e.names[e.facilitator]||"the facilitator")} for the next round…</div>`}function I(e,t){return`<div class="stage-kicker">Round ${e.round} — ${m(t)}</div>`}const zt={renderPick(e,t){const n=e.iAmCommitted;return`
...
`).trim()+`
`}async function Ge(e){try{await navigator.clipboard.writeText(e)}catch{prompt("Copy this:",e);return}const t=g("toast");t&&(t.textContent="Copied",t.classList.add("show"),setTimeout(()=>{t.classList.remove("show"),t.textContent="Link copied"},1800))}function De(e,t){const n=new Blob([e],{type:"text/markdown"}),o=URL.createObjectURL(n),s=document.createElement("a");s.href=o,s.download=t,document.body.appendChild(s),s.click(),s.remove(),URL.revokeObjectURL(o)}const Xt={configForm(e){const t=e.template||"wwda",n=e.privacy||"blind";return`
      <div class="field">
    ...
    </div>`}function nn(e,t,n,o){if(document.querySelectorAll("[data-game]").forEach(a=>a.addEventListener("click",()=>{const u=a.dataset.game,d=Z(u);d&&(d.needsConfig?(n.configGame=u,n.configDraft={},o()):t.selectGame(u,d.defaultConfig(e)))})),n.configGame){const a=ee(n.configGame);document.querySelectorAll("#stage input, #stage textarea").forEach(u=>u.addEventListener("input",()=>{n.configDraft=a.readConfig()}))}const s=document.getElementById("startConfiguredBtn");s&&s.addEventListener("click",()=>{const a=n.configGame,u=Z(a),d=ee(a),f=u.normalizeConfig(d.readConfig());if(!d.configValid(f)){const c=document.getElementById("configError");c&&(c.textContent="That setup isn’t complete yet.");return}n.configGame=null,n.configDraft=null,t.selectGame(a,f)});const r=document.getElementById("cancelConfigBtn");r&&r.addEventListener("click",()=>{n.configGame=null,n.configDraft=null,o()})}const on="wss://tablestakes-turn.joshuarlowry.workers.dev",sn=()=>new URLSearchParams(location.hash.replace(/^#/,"")),ie=()=>`${location.origin}${location.pathname}?room=${encodeURIComponent(O)}#token=${encodeURIComponent(j)}`;let S=null,O=null,j="",_e=!1,M={},ce=-1,He=null,ze=null;rn();const Ue=new URLSearchParams(location.search);O=Ue.get("room");_e=!O;j=sn().get("token")||Ue.get("token")||"";j&&(g("inviteTokenInput").value=j);if(O){g("createBtn").textContent="Join room";const e=g("joinNote");e.style.display="inline",e.textContent=`joining ${O}`}g("createBtn").addEventListener("click",We);g("nameInput").addEventListener("keydown",e=>{e.key==="Enter"&&We()});g("copyBtn").addEventListener("click",async()=>{Ve();const e=g("inviteLinkInput").value;try{await navigator.clipboard.writeText(e)}catch{prompt("Copy this link:",e)}const t=g("toast");t.classList.add("show"),setTimeout(()=>t.classList.remove("show"),1800)});g("leaveBtn").addEventListener("click",an);async function We(){const e=g("nameInput").value.trim();if(!e){g("nameInput").focus();return}if(O){if(j=g("inviteTokenInput").value.trim()||j,!j){g("transportError").textContent="This room needs an invitation token.";return}history.replaceState(null,"",ie())}else{const n=mt();O=n.roomId,j=n.inviteToken,g("inviteTokenInput").value=j,history.replaceState(null,"",ie())}const t=ft({wsUrl:on,roomId:O,inviteToken:j,name:e,onHealth:ln,onError:cn});S=Ht({transport:t,name:e,autoVerify:!0,isCreator:_e,roomId:O}),S.onChange(le),S.join(),He=setInterval(()=>S.heartbeat(),5e3),ze=setInterval(()=>S.tick(),2e3),g("entry").classList.add("hidden"),g("room").classList.add("visible"),g("roomCodeText").textContent=O,Ve(),le(S.getView())}function rn(){const e=g("gamesTeaseGrid");e&&(e.innerHTML=Fe.map(t=>`
    <div class="tease-card" title="${m(t.description)}">
      <span class="tease-glyphs">${t.glyphs}</span>
      <span class="tease-name">${m(t.label)}</span>
    </div>`).join(""))}function Ve(){!O||!j||(g("inviteLinkInput").value=ie())}function an(){S==null||S.leave(),S=null,clearInterval(He),clearInterval(ze),O=null,j="",M={},ce=-1,history.replaceState(null,"",location.pathname),g("room").classList.remove("visible"),g("entry").classList.remove("hidden"),g("createBtn").textContent="Start a room",g("joinNote").style.display="none",g("joinNote").textContent="",g("roomCodeText").textContent="",g("inviteLinkInput").value="",g("inviteTokenInput").value="",g("transportError").textContent="",g("healthErrors").textContent="",g("localPeerId").textContent="pending",g("transportStatus").textContent="idle",g("peerCount").textContent="0",g("reconnectAttempts").textContent="0",g("players").innerHTML="",g("stage").innerHTML="",Je(!1,0)}function cn(e){g("healthErrors").textContent=e.message||String(e)}function ln(e){g("localPeerId").textContent=e.localPeerId||"pending",g("transportStatus").textContent=e.status,g("peerCount").textContent=String(e.peerCount),g("reconnectAttempts").textContent=String(e.reconnectAttempts)}function Je(e,t){g("conn").classList.toggle("live",e),g("connText").textContent=e?`${t} connected`:S?"waiting for peers":"offline"}function le(e){e.round!==ce&&(M={},ce=e.round),un(e);const t=g("stage"),n=e.game?ee(e.game):null;e.phase==="lobby"||!n?t.innerHTML=tn(e,M):e.phase==="board"?t.innerHTML=n.renderBoard(e,M):e.phase==="pick"?t.innerHTML=n.renderPick(e,M)+dn(e):t.innerHTML=n.renderReveal(e),mn(e,n),Je(e.participants.length>1,e.participants.length)}function dn(e){return e.isFacilitator&&e.iAmCommitted&&e.remaining>0?'<div class="stage-actions"><button class="btn-ghost" id="forceBtn">Reveal now</button></div>':""}function un(e){g("players").innerHTML=e.participants.map(t=>`
